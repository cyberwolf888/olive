    ...
    <aside id="slide-out" class="side-nav white fixed">
        <div class="side-nav-wrapper">
            ...
            <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                ...
                <li class="no-padding"><a class="waves-effect waves-grey" href="{{ url('master/category') }}"><i class="material-icons">view_column</i>Category</a></li>
                <li class="no-padding"><a class="waves-effect waves-grey" href="{{ url('master/product') }}"><i class="material-icons">store</i>Product</a></li>
