...
@section('content')
    ...
    <main class="mn-inner">
        <div class="row">
            ...
            @endif
            {!! Form::open(['route' => 'promotion.process', 'method' => 'post']) !!}
                        ...
                        <table id="example" class="display responsive-table datatable-example">
                            ...
                            @foreach($subscriber as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url(route('promotion.delete', ['id' => $row->id])) }}" class="btn-floating red" style="opacity: 1;"><i class="material-icons">clear</i></a>
                                    </td>
                                </tr>
                                <?php $no++; ?>
                            @endforeach
