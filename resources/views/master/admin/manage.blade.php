            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <a class="waves-effect waves-light btn" href="{{ route('admin.create') }}"><i class="material-icons left">open_in_new</i>Add New Data</a><br>
                        <table id="example" class="display responsive-table datatable-example">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url(route('admin.edit', ['id' => $row->id])) }}" class="btn-floating orange" style="opacity: 1;"><i class="material-icons">mode_edit</i></a>
                                    </td>
                                </tr>
                                <?php $no++; ?>
                            @endforeach
